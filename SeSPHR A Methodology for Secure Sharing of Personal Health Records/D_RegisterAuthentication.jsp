...
<%
				...
				try {
					...
					if ( rs1.next() )
					  ...
					  PreparedStatement ps=connection.prepareStatement("insert into doctor(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status,role,hospital) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
