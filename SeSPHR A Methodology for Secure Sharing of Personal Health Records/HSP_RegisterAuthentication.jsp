...
<%
				...
				try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from healthcare_provider  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="HSP_Login.jsp">Back</a>         <a href="index.html">Home</a> </p>
							<%
					  ...
					  PreparedStatement ps=connection.prepareStatement("insert into healthcare_provider(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status) values(?,?,?,?,?,?,?,?,?,?,?)");
